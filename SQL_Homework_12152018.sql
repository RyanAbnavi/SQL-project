...
-- nIt turns out that GROUCHO was the correct name after all! 
...
FROM customer cu
JOIN customer_list cu_list ON (cu.customer_id = cu_list.ID)
WHERE cu_list.country = 'Canada';
...
-- First solution:
SELECT title, COUNT(*) AS 'Count_of_Rented_Movies'
FROM  film f
JOIN inventory i ON (f.film_id= i.film_id)
JOIN rental r ON (i.inventory_id=r.inventory_id)
GROUP BY title 
ORDER BY Count_of_Rented_Movies DESC, title ASC;

-- Second solution
SELECT 
    title, COUNT(*) AS 'Count_of_Rented_Movies'
FROM
    film,
    inventory,
    rental
